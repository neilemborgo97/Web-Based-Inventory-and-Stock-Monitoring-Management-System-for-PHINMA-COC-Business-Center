...
(1, '2324-13450', 4, '2025-09-04', '2025-09-30', 26000.00, 1, '', '2025-09-04 14:21:25', '2025-09-04 17:51:22'),
...
(4, '123123123', 4, '2025-09-05', '2025-09-16', 50400.00, 1, '', '2025-09-04 17:36:07', '2025-09-04 17:36:07'),
(5, '1231231235435', 2, '2025-09-05', '2025-09-30', 60000.00, 1, '', '2025-09-04 17:37:00', '2025-09-04 17:37:00');
...
--
ALTER TABLE `tblinventory_adjustment_items`
  MODIFY `adjustment_items_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblinventory_transfer_items`
  MODIFY `transfer_items_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblpurchaseorders`
  MODIFY `purchaseorders_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tblpurchaseorders_status_update`
  MODIFY `purchaseorders_status_update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `tblpurchaseorder_items`
--
ALTER TABLE `tblpurchaseorder_items`
  MODIFY `purchaseorder_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tblpurchasereturns`
--
ALTER TABLE `tblpurchasereturns`
  MODIFY `purchasereturns_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tblpurchasereturns_items`
--
ALTER TABLE `tblpurchasereturns_items`
  MODIFY `purchasereturns_items_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblreceiving_items`
  MODIFY `receiving_items_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblstocklevels`
  MODIFY `stocklevels_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblwarehouses`
  MODIFY `warehouses_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
